...
DEFAULT_OUTPUT_PATH = os.path.join(PROJECT_ROOT, "data", "telemetry.csv")
...
if __name__ == "__main__":
    # Use DEFAULT_OUTPUT_PATH which correctly points to PROJECT_ROOT/data/telemetry.csv
    ...
    print(f"Generated {n_runs} runs, {n_windows} total windows -> {DEFAULT_OUTPUT_PATH}")
